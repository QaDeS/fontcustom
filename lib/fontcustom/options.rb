...
module Fontcustom
  class Options
    ...
    attr_reader :project_root, :input, :output, :config, :templates, :font_name, :css_prefix, :data_cache, :preprocessor_path, :no_hash, :grouped, :debug, :quiet, :skip_first 
    ...
    def merge_options
      ...
      keys = %w|project_root input output data_cache templates font_name css_prefix preprocessor_path skip_first no_hash grouped debug quiet|
